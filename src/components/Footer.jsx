...
const Footer = () => {
    return (
        <>
            <footer className="relative w-full bg-[#444643]">
            ...
            <div className="flex w-full flex-col items-center justify-center border-t py-4 bg-cyan-600">
                <Typography
                    variant="small"
                    className="text-white"
                >
                    Copyright &copy; {currentYear} Freepik
                </Typography>
            </div>
        </>
    )
